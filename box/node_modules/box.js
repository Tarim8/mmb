...
action.edittag = function( path, options ) {
	...
	console.log( "edit tag attach " + Tag );
	if( memories.lookup( Tag ) ) {
	    commands.synthesize( universal.lookup( 'errtagattached.tag' ) );

	} else {
console.log( "touching: " + pa.join( memories.flowers[currentTrack].stalk, Tag ) );
	...
	log( 'Unknown edit tag action ' + options.action );
    }
};
