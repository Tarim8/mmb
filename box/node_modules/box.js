...
var recorderChannel = new mc.Channel();
mc.recorder.channel = recorderChannel;
mc.recorder.tmpFile = '/tmp/mcrecord' + process.pid + '.wav';

mc.recorder.callback = function( exitCode ) {
	log( 'Info recorder exit callback ' + exitCode );
    
	if( exitCode === 0 ) {
	    collection.createFlower( mc.recorder.tmpFile, {
		destName: '%D.wav',
		move: true,
