...
var rfidReader = new mc.Reader( inputDevice, lookupTag );

var pollSession = new mc.Session( 'poll', [
	'--unique',
	'+record%s',
	pa.join( platformDir, 'right-button.input' )
    ], null, {}
);

var pollReader = new mc.Reader( pollSession.leader.stdout, lookupTag );
